...
// configure
$from = 'info@plusequalz.com'; // Replace it with Your Hosting Admin email. REQUIRED!
$sendTo = 'nithyap322@gmail.com'; // Replace it with Your email. REQUIRED!
$subject = 'New message from contact form from your portfolio site';
