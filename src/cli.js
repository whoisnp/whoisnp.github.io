...
const struct = {
  root: ["about", "resume", "contact", "certificates"],
  skills: ["proficient", "familiar"],
};

const commands = {};
let systemData = {};
const rootPath = "users/whoisnp/root";
...
$(() => {
  ...
  pages.push($.get("pages/certificates.html"));
  $.when
    .apply($, pages)
    .done(
      (
        ...
        systemData["certificates"] = certificatesData[0];
      }
    );
